        ...
        <div className="post">
            <div className="post-header">
                <div>
                    <div className="post-details">
                        <img className="post-creator-img" src={imgSrc} alt="" />
                        <div>
                            <span className="post-creator-name">{name}</span>
                            <div className="post-audience">
                                <span>{postAge}</span>
                                <span>·</span>
                                <img src="/images/post/friends.svg" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    style={{ color: '#050505', fontWeight: 'lighter', marginTop: '.5em' }}
                >
                    {caption}
                </div>
            </div>
            ...
            <div className="post-extras">
                <div className="reactions">
                    <div className="reactions-divider">
                ...
                <div className="post-controls">
                    <div>
                        <i
                            ...
                            style={{
                                backgroundImage:
                                    'url("https://static.xx.fbcdn.net/rsrc.php/v3/yw/r/pNJLcjOueev.png?_nc_eui2=AeE9UncW0BLwKu4dwdYUwxckdcioM_XXiEF1yKgz9deIQcL2GeL6b8sVTypreQWzS2IwYhy2PylEpzI7eQjjxAAj")',
                                backgroundPosition: "0 -322px",
                                backgroundSize: "auto",
                                width: 18,
                                height: 18,
